...
if __name__ == "__main__":
    ...
    wCoeffs = embedding("mono-piano.wav", "right.png", "stego-magnitudo002", 2, GRAYSCALE, "magnitudo", 1)
    ...
    extraction(wCoeffs, "mono-piano.wav", "magnitudo002-right.png", 2, "magnitudo", 1)
