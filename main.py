...
def main():
    ...
    #PSNR & Pearson
    result = compareWatermark(opt.watermark, stegoImage, BINARY)
    ...
    result = compareWatermark(stegoImage, outputDir + "12000-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "24000-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "36000-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "48001-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "amplitude0.5-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "amplitude2-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "butter2-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "butter4-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "butter6-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "gauss0.0001-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "gauss0.0002-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "gauss0.00015-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    result = compareWatermark(stegoImage, outputDir + "gauss5e-05-" + relativeStegoImage, BINARY)
    print("The extracted watermark is correlated to that original? ", result[0])
    print("The PSNR between the two watermarks is: ", result[1])
    ...
    snr = compareAudio(stegoAudio, outputDir + "48001-" + relativeStegoAudio)
    print("SNR of {} is: {}\nSNR of {} is: {}".format(stegoAudio, snr[0], "48001-" + relativeStegoAudio, snr[1]))
